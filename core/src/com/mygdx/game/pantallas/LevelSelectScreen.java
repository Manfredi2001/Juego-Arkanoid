...
public class LevelSelectScreen extends AbstractScreen {
    ...
    public LevelSelectScreen() {
        super();
        txtrBg   = new Texture( Gdx.files.internal("level_select_bg.png") );
        txtrBack = new Texture( Gdx.files.internal("btn_back.png") );
        txtrLevel1 = new Texture( Gdx.files.internal("btn_level_1.png") );
        txtrLevel2 = new Texture( Gdx.files.internal("btn_level_2.png") );
    }
